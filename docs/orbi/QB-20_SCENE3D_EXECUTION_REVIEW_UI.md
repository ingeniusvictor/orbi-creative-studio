...
QB-20 v2 is rebuilt on QB-19 v2 and inherits the full QB-12 → QB-19 dependency chain.
...
**QB-20 v2 status: IMPLEMENTATION CANDIDATE — governed review UI, all authority default OFF.**


## Rebuild note

This v2 candidate starts from QB-19 v2, preserving all current launch, child-environment,
renderer-sanitization, diagnostics, execution-authority, and review-token hardening.
