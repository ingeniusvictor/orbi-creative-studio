...
const translations = {
    en: {
        ...
        'settings.routerDiagnostics': 'Router Diagnostics',
        'routerDiagnostics.title': 'Compute Router Diagnostics',
        'routerDiagnostics.subtitle': 'Read-only parity evidence for the current desktop session.',
        'routerDiagnostics.refresh': 'Refresh',
        'routerDiagnostics.sessionSamples': 'Session samples',
        'routerDiagnostics.observedRoutes': 'Observed routes',
        'routerDiagnostics.targets': 'Target routes',
        'routerDiagnostics.certification': 'Certification',
        'routerDiagnostics.certified': 'Certified',
        'routerDiagnostics.notCertified': 'Not certified',
        'routerDiagnostics.targetRoutes': 'Certification target routes',
        'routerDiagnostics.textReport': 'Diagnostic report',
        'routerDiagnostics.readOnlyNote': 'Read-only diagnostics. This panel cannot select providers, enable fallback, or authorize execution.',
        'routerDiagnostics.unavailable': 'Router diagnostics are currently unavailable.',
        'routerDiagnostics.samples': 'samples',
        'routerDiagnostics.models': 'models',
        'routerDiagnostics.reasons': 'reasons',
        'routerDiagnostics.statusCertified': 'Certified',
        'routerDiagnostics.statusMismatch': 'Mismatch',
        'routerDiagnostics.statusBlocked': 'Blocked',
        ...
        'routerDiagnostics.shadowTitle': 'Shadow local compatibility',
        'routerDiagnostics.shadowSubtitle': 'Sanitized resource-fit diagnostics from a certified profile. Read-only.',
        'routerDiagnostics.shadowUnavailable': 'No validated shadow compatibility snapshot is available.',
        'routerDiagnostics.shadowContext': 'Model / backend / resolution',
        'routerDiagnostics.shadowCompatibility': 'Compatibility',
        'routerDiagnostics.shadowProfile': 'Resource profile',
        'routerDiagnostics.shadowCertified': 'Certified',
        'routerDiagnostics.shadowNotCertified': 'Not certified',
        'routerDiagnostics.shadowSystemRam': 'System RAM observed / required',
        'routerDiagnostics.shadowVram': 'VRAM observed / required',
        'routerDiagnostics.shadowReasons': 'Shadow reasons',
        'routerDiagnostics.shadowNoReasons': 'No blocking reasons',
        'routerDiagnostics.shadowCandidate': 'Candidate',
        ...
        'routerDiagnostics.runtimeCertificationTitle': 'Runtime certified resource profiles',
        'routerDiagnostics.runtimeCertificationSubtitle': 'Read-only status of the governed source used by local compatibility diagnostics.',
        'routerDiagnostics.runtimeCertificationUnavailable': 'Runtime certification status is unavailable.',
        'routerDiagnostics.runtimeCertificationSource': 'Certification source',
        'routerDiagnostics.runtimeCertificationSourceControlled': 'Source-controlled bundle',
        'routerDiagnostics.runtimeCertificationCount': 'Certified profiles loaded',
        'routerDiagnostics.runtimeCertificationContract': 'Source contract',
        'routerDiagnostics.runtimeCertificationValid': 'Valid',
        'routerDiagnostics.runtimeCertificationInvalid': 'Unavailable',
        'routerDiagnostics.runtimeCertificationAuthenticity': 'Authenticity verified',
        'routerDiagnostics.runtimeCertificationNotVerified': 'No',
        'routerDiagnostics.runtimeCertificationEmptyNote': 'No genuine P1C8 runtime certifications are loaded. Compatibility may remain unknown until a real benchmark + human certification is deliberately committed.',
        'routerDiagnostics.runtimeCertificationLoadedNote': 'Only source-controlled P1C8 certifications that pass P1C9 validation are visible to diagnostics.',
    ...
    zh: {
        ...
        'settings.routerDiagnostics': '路由诊断',
        'routerDiagnostics.title': '计算路由诊断',
        'routerDiagnostics.subtitle': '当前桌面会话的只读路由一致性证据。',
        'routerDiagnostics.refresh': '刷新',
        'routerDiagnostics.sessionSamples': '会话样本',
        'routerDiagnostics.observedRoutes': '已观察路由',
        'routerDiagnostics.targets': '目标路由',
        'routerDiagnostics.certification': '认证状态',
        'routerDiagnostics.certified': '已认证',
        'routerDiagnostics.notCertified': '未认证',
        'routerDiagnostics.targetRoutes': '认证目标路由',
        'routerDiagnostics.textReport': '诊断报告',
        'routerDiagnostics.readOnlyNote': '只读诊断。此面板不能选择提供商、启用回退或授权执行。',
        'routerDiagnostics.unavailable': '路由诊断当前不可用。',
        'routerDiagnostics.samples': '样本',
        'routerDiagnostics.models': '模型',
        'routerDiagnostics.reasons': '原因',
        'routerDiagnostics.statusCertified': '已认证',
        'routerDiagnostics.statusMismatch': '不一致',
        'routerDiagnostics.statusBlocked': '已阻止',
        ...
        'routerDiagnostics.shadowTitle': '本地影子兼容性',
        'routerDiagnostics.shadowSubtitle': '来自已认证资源配置的净化资源适配诊断。仅只读。',
        'routerDiagnostics.shadowUnavailable': '当前没有可用的已验证影子兼容性快照。',
        'routerDiagnostics.shadowContext': '模型 / 后端 / 分辨率',
        'routerDiagnostics.shadowCompatibility': '兼容性',
        'routerDiagnostics.shadowProfile': '资源配置',
        'routerDiagnostics.shadowCertified': '已认证',
        'routerDiagnostics.shadowNotCertified': '未认证',
        'routerDiagnostics.shadowSystemRam': '系统内存 已观察 / 所需',
        'routerDiagnostics.shadowVram': '显存 已观察 / 所需',
        'routerDiagnostics.shadowReasons': '影子诊断原因',
        'routerDiagnostics.shadowNoReasons': '无阻止原因',
        'routerDiagnostics.shadowCandidate': '候选',
        ...
        'routerDiagnostics.runtimeCertificationTitle': '运行时已认证资源配置',
        'routerDiagnostics.runtimeCertificationSubtitle': '本地兼容性诊断所使用的受控来源只读状态。',
        'routerDiagnostics.runtimeCertificationUnavailable': '运行时认证状态不可用。',
        'routerDiagnostics.runtimeCertificationSource': '认证来源',
        'routerDiagnostics.runtimeCertificationSourceControlled': '源码受控配置包',
        'routerDiagnostics.runtimeCertificationCount': '已加载认证配置',
        'routerDiagnostics.runtimeCertificationContract': '来源契约',
        'routerDiagnostics.runtimeCertificationValid': '有效',
        'routerDiagnostics.runtimeCertificationInvalid': '不可用',
        'routerDiagnostics.runtimeCertificationAuthenticity': '真实性已验证',
        'routerDiagnostics.runtimeCertificationNotVerified': '否',
        'routerDiagnostics.runtimeCertificationEmptyNote': '当前没有加载真实的 P1C8 运行时认证。只有完成真实基准测试并经人工认证后，兼容性诊断才可能获得已认证资源要求。',
        'routerDiagnostics.runtimeCertificationLoadedNote': '只有通过 P1C9 验证的源码受控 P1C8 认证才会用于诊断。',
