...
const { register: registerComputeRouterReadinessBridge } = require('./lib/computeRouterReadinessBridge');
...
app.whenReady().then(() => {
    ...
    try {
        ...
        console.error('Failed to register Compute Router readiness bridge:', err);
    }
