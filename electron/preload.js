...
// Read-only, sanitized readiness snapshot for the future Compute Router.
// No generation action, provider secret, filesystem path, or arbitrary command
// surface is exposed through this bridge.
